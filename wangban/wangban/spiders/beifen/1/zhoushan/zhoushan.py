...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'zhoushan.json')


class ZhouShanSpider(RedisStaticSpider):
    name = 'zhoushan'
    start_urls = ['http://www.zsztb.gov.cn/']
    source_website = '舟山市公共资源交易网'
    specific_area = '舟山'
    source_url = 'http://www.zsztb.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

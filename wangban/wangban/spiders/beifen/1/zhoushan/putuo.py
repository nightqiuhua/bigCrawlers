...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'putuo.json')


class PuTuoSpider(RedisStaticSpider):
    name = 'putuo'
    start_urls = ['http://www.zsptztb.com.cn']
    source_website = '舟山市普陀区招标投标网'
    specific_area = '普陀区'
    source_url = 'http://www.zsptztb.com.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

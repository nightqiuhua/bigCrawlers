...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'daishan.json')


class DaiShanSpider(RedisStaticSpider):
    name = 'daishan'
    start_urls = ['http://ds.zsztb.gov.cn/']
    source_website = '舟山市岱山县招标投标网'
    specific_area = '岱山'
    source_url = 'http://ds.zsztb.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

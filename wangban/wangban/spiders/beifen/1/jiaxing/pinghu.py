...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'pinghu.json')


class PingHuSpider(RedisStaticSpider):
    name = 'pinghu'
    start_urls = ['http://ph.jxzbtb.cn/']
    source_website = '嘉兴市平湖市公共资源交易网'
    specific_area = '平湖市'
    source_url = 'http://ph.jxzbtb.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

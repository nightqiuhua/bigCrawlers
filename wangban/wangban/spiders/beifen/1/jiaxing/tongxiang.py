...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'tongxiang.json')


class TongXiangSpider(RedisStaticSpider):
    name = 'tongxiang'
    start_urls = ['http://tx.jxzbtb.cn/']
    source_website = '嘉兴市桐乡公共资源交易网'
    specific_area = '桐乡市'
    source_url = 'http://tx.jxzbtb.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

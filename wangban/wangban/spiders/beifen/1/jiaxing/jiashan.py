...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'jiashan.json')


class JiaShanSpider(RedisStaticSpider):
    name = 'jiashan'
    start_urls = ['http://js.jxzbtb.cn/']
    source_website = '嘉兴市嘉善县公共资源交易网'
    specific_area = '嘉善'
    source_url = 'http://js.jxzbtb.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

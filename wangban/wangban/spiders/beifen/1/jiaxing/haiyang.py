...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'haiyang.json')


class HaiYangSpider(RedisStaticSpider):
    name = 'haiyang'
    start_urls = ['http://hy.jxzbtb.cn/']
    source_website = '嘉兴市海盐县公共资源交易网'
    specific_area = '海盐县'
    source_url = 'http://hy.jxzbtb.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

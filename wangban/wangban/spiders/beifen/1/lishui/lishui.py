...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'lishui.json')


class LiShuiSpider(RedisStaticSpider):
    name = 'lishui'
    start_urls = ['http://www.lssggzy.com/']
    source_website = '丽水市公共资源交易网'
    specific_area = '丽水'
    source_url = 'http://www.lssggzy.com/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

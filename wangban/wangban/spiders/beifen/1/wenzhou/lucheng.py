...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'lucheng.json')


class LuChengSpider(RedisStaticSpider):
    name = 'lucheng'
    start_urls = ['http://218.75.25.60:6081/']
    source_website = '温州市鹿城区公共资源交易网'
    specific_area = '鹿城区'
    source_url = 'http://218.75.25.60:6081/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

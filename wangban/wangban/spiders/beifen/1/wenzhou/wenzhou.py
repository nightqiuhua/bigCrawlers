...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'wenzhou.json')


class WenZhouSpider(RedisStaticSpider):
    name = 'wenzhou'
    start_urls = ['https://ggzy.wzzbtb.com/']
    source_website = '温州市公共资源交易网'
    specific_area = '温州'
    source_url = 'https://ggzy.wzzbtb.com/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'xiangshan.json')


class XiangShanSpider(RedisStaticSpider):
    name = 'xiangshan'
    start_urls = ['http://xiangshan.bidding.gov.cn/']
    source_website = '宁波市公共资源交易网象山县分网'
    specific_area = '象山县'
    source_url = 'http://xiangshan.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'yinzhou.json')


class YinZhouSpider(RedisStaticSpider):
    name = 'yinzhou'
    start_urls = ['http://yinzhou.bidding.gov.cn/']
    source_website = '宁波市鄞州区公共资源交易网'
    specific_area = '鄞州'
    source_url = 'http://yinzhou.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

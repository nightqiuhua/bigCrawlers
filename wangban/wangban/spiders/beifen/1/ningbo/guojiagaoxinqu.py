...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'guojiagaoxinqu.json')


class GuoJiaGaoXinQuSpider(RedisStaticSpider):
    name = 'guojiagaoxinqu'
    start_urls = ['http://gaoxin.bidding.gov.cn/']
    source_website = '宁波市国家高新区公共资源交易网'
    specific_area = '高新区'
    source_url = 'http://gaoxin.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'yuyao.json')


class YuYaoSpider(RedisStaticSpider):
    name = 'yuyao'
    start_urls = ['http://yuyao.bidding.gov.cn/']
    source_website = '宁波市余姚市公共资源交易网'
    specific_area = '余姚市'
    source_url = 'http://yuyao.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

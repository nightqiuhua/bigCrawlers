...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'ningbobaoshuiqu.json')


class NiBoBSQSpider(RedisStaticSpider):
    name = 'ningbobaoshuiqu'
    start_urls = ['http://baosui.bidding.gov.cn/']
    source_website = '宁波市保税区公共资源交易网'
    specific_area = '保税区'
    source_url = 'http://baosui.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'haishu.json')


class HaiShuSpider(RedisStaticSpider):
    name = 'haishu'
    start_urls = ['http://haishu.bidding.gov.cn/']
    source_website = '宁波市海曙区公共资源交易网'
    specific_area = '海曙区'
    source_url = 'http://haishu.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

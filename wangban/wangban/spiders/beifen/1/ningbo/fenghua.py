...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'fenghua.json')


class FengHuaSpider(RedisStaticSpider):
    name = 'fenghua'
    start_urls = ['http://fenghua.bidding.gov.cn/']
    source_website = '宁波市奉化区公共资源交易网'
    specific_area = '奉化'
    source_url = 'http://fenghua.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

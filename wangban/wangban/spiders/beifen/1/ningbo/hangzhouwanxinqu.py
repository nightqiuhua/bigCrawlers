...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'hangzhouwanxinqu.json')


class HangZhouWanXinQuSpider(RedisStaticSpider):
    name = 'hangzhouwanxinqu'
    start_urls = ['http://hangzw.bidding.gov.cn/']
    source_website = '宁波市杭州湾新区公共资源交易网'
    specific_area = '杭州湾新区'
    source_url = 'http://hangzw.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

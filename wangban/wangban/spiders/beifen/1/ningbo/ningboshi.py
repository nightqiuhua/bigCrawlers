...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'ningboshi.json')


class NingBoSpider(RedisStaticSpider):
    name = 'ningboshi'
    start_urls = ['http://www.bidding.gov.cn/']
    source_website = '宁波市公共资源交易网'
    specific_area = '宁波'
    source_url = 'http://www.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

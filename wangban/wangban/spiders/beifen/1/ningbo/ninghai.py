...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'ninghai.json')


class NingHaiSpider(RedisStaticSpider):
    name = 'ninghai'
    start_urls = ['http://ninghai.bidding.gov.cn/']
    source_website = '宁波市宁海县公共资源交易网'
    specific_area = '宁海县'
    source_url = 'http://ninghai.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

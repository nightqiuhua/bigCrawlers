...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'zhenhai.json')


class ZhenHaiSpider(RedisStaticSpider):
    name = 'zhenhai'
    start_urls = ['http://zhenhai.bidding.gov.cn/']
    source_website = '宁波市镇海区公共资源交易网'
    specific_area = '镇海区'
    source_url = 'http://zhenhai.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

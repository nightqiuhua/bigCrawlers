...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'jiangbei.json')


class JiangBeiSpider(RedisStaticSpider):
    name = 'jiangbei'
    start_urls = ['http://jiangbei.bidding.gov.cn/']
    source_website = '宁波市江北区公共资源交易网'
    specific_area = '江北区'
    source_url = 'http://jiangbei.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []

...
JSONFILE = os.path.join(SETTINGS['BASE_JSONFILE_PATH'],'beilun.json')


class BeiLunSpider(RedisStaticSpider):
    name = 'beilun'
    start_urls = ['http://beilun.bidding.gov.cn/']
    source_website = '宁波市北仑区公共资源交易网'
    specific_area = '北仑区'
    source_url = 'http://beilun.bidding.gov.cn/'
    links_tree = {}
    loss_urls = {}
    column_urls_pool = []
